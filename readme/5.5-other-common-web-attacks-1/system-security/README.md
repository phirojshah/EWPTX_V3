...
> 1. [ XSS Anatomy](4.2.1-xss-anatomy.md)
> 2. [Reflected XSS](4.2.2-reflected-xss.md)
> 3. [Stored XSS](4.2.3-stored-xss.md)
> 4. [DOM-Based XSS](4.2.4-dom-based-xss.md)
> 5. [Identifying & Exploiting XSS with XSSer](4.2.5-identifying-and-exploiting-xss-with-xsser.md)
