...
> 1. [DB & SQL Introduction](4.3.1-db-and-sql-introduction.md)
> 2. [SQL Injection (SQLi)](4.3.2-sql-injection-sqli.md)
> 3. [In-Band SQL Injection](4.3.3-in-band-sqli.md)
> 4. [Blind SQLi](4.3.4-blind-sqli.md)
> 5. [NoSQL](4.3.5-nosql.md)
> 6. [SQLMap](4.3.6-sqlmap.md)
> 7. [Mitigation Strategies](4.3.7-mitigation-strategies.md)
