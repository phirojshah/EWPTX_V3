...
* [Basic SSRF against the local server](https://app.gitbook.com/s/rRWtuMw6xkkeDjZfkcWC/portswigger-web-security-academy/server-side-vulnerabilities/server-side-request-forgery-ssrf/basic-ssrf-against-the-local-server)
* [Basic SSRF against another back-end system](https://app.gitbook.com/s/rRWtuMw6xkkeDjZfkcWC/portswigger-web-security-academy/server-side-vulnerabilities/server-side-request-forgery-ssrf/basic-ssrf-against-another-back-end-system)
